...
my_colours("Red", "Green", "Blue")  #call function

#Arbitrary Arguments, *args whe not sure how much parameters will be there
def my_named_colours(**colours):
  print("The first colour is " + colours["red"])
...
# function with if, continue, else....
def test_my_function(*names):
    for x in names:
        if(x=="bb"):
            continue
        print(x)
    else:
        print("The second name in the collection is " + names[1])
test_my_function("aa","bb","cc","dd")   #call function